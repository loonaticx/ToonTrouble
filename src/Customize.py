...
def testCogHeadsHere():
    ...
    for modelName in modelArrTwo:
        ...
        for node in tempLoader.nodes:
            print(node)
    print(testTwo.nodes)
    print(testTwo.ancestors)
    print(testTwo.children)
    print(testTwo.findAllMaterials())
    print(testTwo.getNodes())

def annoyingTempHeadList():
...
def loadButtons(actor):
    ...
    thisIsTemp = annoyingTempHeadList()
